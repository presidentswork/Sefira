...
function omerCount(day){const w=Math.floor((day-1)/7),r=day-w*7;let t="הַיּוֹם "+OH[day]+" יָמִים";if(w>0){t+=" "+WK[w];if(r>0)t+=" "+WD[r];}return t+" לָעֹמֶר";}
...
function BodyFigure({part,color}){
  ...
  return(
    <svg viewBox="0 0 60 120" width="52" height="104" style={{display:"block",flexShrink:0}}>
      ...
      <rect x="6" y="24" width="12" height="32" rx="5" fill={c("right_arm")} transform="rotate(-4,12,40)"/>
      <rect x="42" y="24" width="12" height="32" rx="5" fill={c("left_arm")} transform="rotate(4,48,40)"/>
      <rect x="20" y="55" width="10" height="36" rx="5" fill={c("right_leg")}/>
      <rect x="30" y="55" width="10" height="36" rx="5" fill={c("left_leg")}/>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(340px,1fr))",gap:20,alignItems:"start"}}>
          ...
          <div className="omer-col-prayer">
            ...
            <PrayerBlock title="הֲכָנָה — Preparation" accent={accent} dm={dm}>
              ...
              <div style={{fontSize:16,lineHeight:2.4,color:hebColor,direction:"rtl",textAlign:"right",fontFamily:"Georgia,serif",marginTop:8,paddingTop:8,borderTop:`1px solid ${divCard}`}}>
                וּסְפַרְתֶּם לָכֶם מִמָּחֳרַת הַשַּׁבָּת מִיּוֹם הֲבִיאֲכֶם אֶת עֹמֶר הַתְּנוּפָה<br/>
                שֶׁבַע שַׁבָּתוֹת תְּמִימֹת תִּהְיֶינָה:<br/>
